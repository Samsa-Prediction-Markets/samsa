...
const TOPICS = {
  politics: [
    { id: 'Q7188', name: 'Government' },
    { id: 'Q179805', name: 'Political Ideology' },
    { id: 'Q82955', name: 'Political Actors' },
    { id: 'Q7163', name: 'Political Issues' },
    { id: 'Q11033', name: 'Mass Media' },
    { id: 'Q198', name: 'Global Issues' },
    { id: 'USCON', name: 'Congress' },
    { id: 'USPRES', name: 'White House' },
    { id: 'USSC', name: 'Supreme Court', categories: ['law'] },
    { id: 'USELEC', name: 'US Elections' },
    { id: 'USLEG', name: 'Legislation', categories: ['law'] },
    { id: 'USFED', name: 'Federal Reserve', categories: ['finance'] },
    { id: 'USIMM', name: 'Immigration', categories: ['social'] },
    { id: 'USGOV', name: 'State Governors' }
  ],
  international: [
    { id: 'Q1065', name: 'United Nations' },
    { id: 'Q7184', name: 'NATO' },
    { id: 'Q458', name: 'European Union' },
    { id: 'Q8142', name: 'Global Trade' },
    { id: 'Q8458', name: 'Human Rights' },
    { id: 'Q131569', name: 'International Treaty' },
    { id: 'Q7283', name: 'Conflicts' }
  ],
  finance: [
    { id: 'Q8142', name: 'Stock Markets' },
    { id: 'Q192296', name: 'Real Estate' },
    { id: 'Q860861', name: 'Commodities' },
    { id: 'USBANK', name: 'Banking', categories: ['economics'] },
    { id: 'USTAX', name: 'Taxation', categories: ['politics', 'economics'] }
  ],
  environment: [
    { id: 'Q183129', name: 'Conservation' },
    { id: 'Q11023', name: 'Renewable Energy', categories: ['technology', 'climate'] },
    { id: 'Q7918', name: 'Biodiversity', categories: ['science'] },
    { id: 'Q830077', name: 'Sustainable Development', categories: ['economics'] },
    { id: 'Q51908', name: 'Environmental Policy', categories: ['politics'] }
  ],
  climate: [
    { id: 'Q7937', name: 'Global Warming', categories: ['science', 'environment'] },
    { id: 'Q125928', name: 'Carbon Emissions', categories: ['environment'] },
    { id: 'Q1322263', name: 'Climate Agreements', categories: ['politics', 'international'] },
    { id: 'Q124441', name: 'Climate Change Impacts', categories: ['environment', 'science'] }
  ],
  science: [
    { id: 'Q12483', name: 'Space Exploration', categories: ['technology'] },
    { id: 'Q11190', name: 'Medicine', categories: ['health'] },
    { id: 'Q420', name: 'Biology' },
    { id: 'Q47258', name: 'Genetics', categories: ['health', 'technology'] },
    { id: 'Q11016', name: 'Artificial Intelligence', categories: ['technology'] }
  ],
  health: [
    { id: 'Q11190', name: 'Medicine', categories: ['science'] },
    { id: 'Q1928478', name: 'Vaccine', categories: ['science'] },
    { id: 'Q12136', name: 'Disease', categories: ['science'] },
    { id: 'Q3391743', name: 'Public Health', categories: ['politics', 'social'] },
    { id: 'MENTAL', name: 'Mental Health', categories: ['social', 'science'] },
    { id: 'PHARMA', name: 'Pharmaceuticals', categories: ['finance', 'science'] }
  ],
  technology: [
    { id: 'Q11016', name: 'Artificial Intelligence', categories: ['science'] },
    { id: 'CYBER', name: 'Cybersecurity', categories: ['politics'] },
    { id: 'BIGTECH', name: 'Big Tech', categories: ['finance'] },
    { id: 'SOCIAL', name: 'Social Media', categories: ['technology'] },
    { id: 'ELECVEH', name: 'Electric Vehicles', categories: ['environment', 'finance'] }
  ],
};
