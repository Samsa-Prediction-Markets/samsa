    ...
    >
      <SidebarHeader className="border-b border-amber-900/30 p-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-bold text-xl text-white tracking-tight">Samsa</h2>
...
export default function Layout({ children, currentPageName }) {
  return (
    <SidebarProvider defaultOpen={false}>
      ...
      `}</style>
      <div className="min-h-screen flex w-full bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950">
        <SidebarContent_ />
        ...
        <main className="flex-1 flex flex-col">
          <header className="bg-slate-950/30 backdrop-blur-xl border-b border-slate-800 px-6 py-4 lg:hidden">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-bold text-white">Samsa</h1>
            </div>
          </header>
